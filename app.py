...
# -------------------------------
    ...
    st.markdown(f'''
    $\quad\quad\quad\quad\quad\quad\quad ① \enspace {choices[0]}$  
    $\quad\quad\quad\quad\quad\quad\quad ② \enspace {choices[1]}$  
    $\quad\quad\quad\quad\quad\quad\quad ③ \enspace {choices[2]}$  
    $\quad\quad\quad\quad\quad\quad\quad ④ \enspace {choices[3]}$
    ''')
