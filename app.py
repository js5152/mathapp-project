...
# -------------------------------
    ...
    st.markdown(f'''
    $\quad\quad\quad ① \enspace\enspace\enspace\enspace {choices[0]}$  
    $\quad\quad\quad ② \enspace\enspace\enspace\enspace {choices[1]}$  
    $\quad\quad\quad ③ \enspace\enspace\enspace\enspace {choices[2]}$  
    $\quad\quad\quad ④ \enspace\enspace\enspace\enspace {choices[3]}$
    ''')
